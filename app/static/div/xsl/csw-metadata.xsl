...
<table class="meta"><tr></tr>
      ...
      <xsl:with-param name="cname" select="'Uniek nummer'"/>
      <xsl:with-param name="cvalue" select="./gmd:fileIdentifier/gco:CharacterString"/>
      </xsl:call-template>
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Taal'"/>
      ...
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Datum'"/>
      <xsl:with-param name="cvalue" select="./gmd:dateStamp/gco:Date"/>
      </xsl:call-template>
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Metadata standaard'"/>
      <xsl:with-param name="cvalue" select="./gmd:metadataStandardName/gco:CharacterString"/>
      </xsl:call-template>
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Metadata versie'"/>
...
<table class="meta"><tr></tr>
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Telefoon'"/>
      ...
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Postbus'"/>
      ...
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Plaats'"/>
      ...
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Postcode'"/>
      ...
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Land'"/>
...
<table class="meta"><tr></tr>
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Titel'"/>
      ...
      <tr>
      <td class="meta-param">Samenvatting:</td>
      <td class="meta-value">
...
<tr>
<td></td><td class="meta-param" align="center">Noordelijke breedtegraad<br/>
...
<tr>
<td class="meta-param" align="center">Westelijke lengtegraad<br/>
...
<td></td>
<td class="meta-param" align="center">Oostelijke lengtegraad<br/>
...
<tr>
<td></td><td class="meta-param" align="center">Zuidelijk breedtegraad<br/>
    ...
    <xsl:for-each select="gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource">
  	    <xsl:choose>
  		    <xsl:when test="starts-with(./gmd:protocol/gco:CharacterString,'WWW:DOWNLOAD-') and contains(./gmd:protocol/gco:CharacterString,'http--download') and ./gmd:name/gco:CharacterString">
			    <tr>
			      <td class="meta-param">Downloaden:</td>
			      <td class="meta-value">
...
<table class="meta"><tr></tr>
      ...
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Presentatie'"/>
...
<td class="meta-param">Samenvatting:</td><td class="meta-value"><xsl:apply-templates select="./dct:abstract"/></td>
</tr>
</xsl:if>
...
<table class="meta"><tr></tr>
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Onderhoek'"/>
      <xsl:with-param name="cvalue" select="./ows:LowerCorner"/>
      </xsl:call-template>
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Bovenhoek'"/>
