        ...
        var defAttributesComboConfig = {
            ...
            listeners: {
                select: function(combo, record) {
                    ...
                    if (this.filter.property != combo.getValue())
                    {
                    }
                    ...
                    searchField.fieldName = this.filter.property;     
                    searchField.update();
                    searchField.lastQuery = null;
    ...
    createFilterItems: function() {
        ...
        return [
            this.attributesComboConfig, Ext.applyIf({
                ...
                featureType: this.attributes.baseParams.TYPENAME,
                maxFeatures: 200,
                outputFormat: "JSON",
                fieldName: this.filter.property,
                minChars: 0,
                hideTrigger: false,
                triggerAction: 'all',
